...
def lambda_handler(event, context):
    ...
    try:
        ...
        # lambda_invoke_collect_card(game_id, player, position, quantity)
...
# Envia a atualização do estado do jogo para os demais jogadores
...
# Remove as cartas do tabuleiro e computa o placar
def lambda_invoke_collect_card(game_id, connection_id, position, quantity):
    response = lambda_client.invoke(
